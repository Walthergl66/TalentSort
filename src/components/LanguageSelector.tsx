  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={isPending}
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      ...
      {showSuccess && (
        <div className="absolute top-full mt-2 right-0 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-300 px-4 py-2 rounded-lg shadow-lg z-30 flex items-center gap-2 animate-fade-in">
            ...
            {languages.map((lang) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <span className="block text-xs text-gray-500 dark:text-gray-400">{lang.name}</span>
                </div>
                {locale === lang.code && (
